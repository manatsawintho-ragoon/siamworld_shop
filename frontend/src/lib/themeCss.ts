/**
 * Theme definitions and the CSS they generate.
 *
 * Deliberately NOT a 'use client' module. The 33KB stylesheet a non-default
 * theme produces used to be built and injected into <head> after hydration,
 * which forced a full style recalculation and repaint of the whole document -
 * 761ms of style-and-layout on throttled mobile, landing squarely in the window
 * where the hero image was waiting to paint. It also meant every visitor saw the
 * default green theme for a moment before the shop's own colours arrived.
 *
 * Splitting the pure string builder out of the context lets app/layout.tsx (a
 * server component, which already knows settings.theme_name) render the same CSS
 * into the initial HTML. The client keeps injectTheme for the admin's live
 * preview and for a setting that changes mid-session.
 */
...
export const THEMES: ThemeConfig[] = [
  /* ═══════════════════════ LIGHT THEMES ═══════════════════════ */
  {
    ...
    vars: {
      '--color-primary': '23 134 64',
      '--color-primary-text': '19 110 52',
      '--color-primary-hover': '18 135 61',
      ...
      '--color-foreground-subtle': '101 111 126',
      '--color-success': '22 163 74',
      '--color-success-fill': '18 132 60',
      '--color-error': '205 35 35',
      '--color-error-fill': '205 35 35',
      '--color-warning': '217 119 6',
      '--color-warning-ink': '56 31 2',
  ...
  },
  {
    ...
    vars: {
      '--color-primary': '52 114 216',
      '--color-primary-text': '42 92 173',
      ...
      '--color-foreground': '15 23 42',
      '--color-foreground-muted': '71 85 105',
      '--color-foreground-subtle': '100 109 124',
      '--color-success': '5 150 105',
      '--color-success-fill': '4 131 91',
      '--color-error': '205 35 35',
      '--color-error-fill': '205 35 35',
      '--color-warning': '217 119 6',
      '--color-warning-ink': '56 31 2',
  ...
  },
  {
    ...
    vars: {
      '--color-primary': '189 87 17',
      '--color-primary-text': '153 71 13',
      '--color-primary-hover': '201 76 10',
      ...
      '--color-foreground-muted': '71 85 105',
      '--color-foreground-subtle': '104 114 129',
      '--color-success': '22 163 74',
      '--color-success-fill': '18 132 60',
      '--color-error': '205 35 35',
      '--color-error-fill': '205 35 35',
  ...
  },
  {
    ...
    vars: {
      '--color-primary': '132 87 234',
      '--color-primary-text': '106 70 188',
      ...
      '--color-foreground': '15 23 42',
      '--color-foreground-muted': '71 85 105',
      '--color-foreground-subtle': '102 112 127',
      '--color-success': '22 163 74',
      '--color-success-fill': '18 132 60',
      '--color-error': '205 35 35',
      '--color-error-fill': '205 35 35',
  ...
  },
  {
    ...
    vars: {
      '--color-primary': '203 62 132',
      '--color-primary-text': '162 49 105',
  ...
  },
  {
    ...
    vars: {
      '--color-primary': '4 127 148',
      '--color-primary-text': '3 104 122',
      '--color-primary-hover': '7 126 155',
      ...
      '--color-foreground': '15 23 42',
      '--color-foreground-muted': '71 85 105',
      '--color-foreground-subtle': '105 116 131',
      '--color-success': '22 163 74',
      '--color-success-fill': '18 132 60',
      '--color-error': '205 35 35',
      '--color-error-fill': '205 35 35',
  ...
  },
  {
    ...
    vars: {
      '--color-primary': '213 61 61',
      '--color-primary-text': '170 48 48',
  ...
  },
  {
    ...
    vars: {
      '--color-primary': '12 133 93',
      '--color-primary-text': '10 108 75',
      '--color-primary-hover': '4 132 92',
  ...
  },
  {
    ...
    isDark: false,
    vars: {
      '--color-primary': '14 131 118',
      '--color-primary-text': '11 107 97',
      '--color-primary-hover': '11 130 120',
      ...
      '--color-foreground': '15 23 42',
      '--color-foreground-muted': '71 85 105',
      '--color-foreground-subtle': '102 113 127',
      '--color-success': '22 163 74',
      '--color-success-fill': '18 132 60',
      '--color-error': '205 35 35',
      '--color-error-fill': '205 35 35',
  ...
  },
  {
    ...
    isDark: false,
    vars: {
      '--color-primary': '97 100 236',
      '--color-primary-text': '77 80 189',
      ...
      '--color-foreground': '15 23 42',
      '--color-foreground-muted': '71 85 105',
      '--color-foreground-subtle': '98 108 122',
      '--color-success': '22 163 74',
      '--color-success-fill': '18 132 60',
      '--color-error': '205 35 35',
      '--color-error-fill': '205 35 35',
  ...
  },
  {
    ...
    isDark: false,
    vars: {
      '--color-primary': '81 130 10',
      '--color-primary-text': '66 106 8',
  ...
  },
  {
    ...
    isDark: false,
    vars: {
      '--color-primary': '215 55 83',
      '--color-primary-text': '169 44 65',
  ...
  /* ═══════════════════════ DARK THEMES ═══════════════════════ */
  {
    ...
    vars: {
      ...
      '--color-foreground-subtle': '136 148 166',
      '--color-success': '52 211 153',
      '--color-success-fill': '32 129 93',
      '--color-error': '248 113 113',
      '--color-error-fill': '181 82 82',
      '--color-warning': '251 191 36',
      '--color-warning-ink': '100 76 14',
  ...
  },
  {
    ...
    vars: {
      ...
      '--color-primary-text': '152 161 250',
      '--color-primary-hover': '113 116 242',
      '--color-primary-light': '165 180 252',
  ...
  },
  {
    ...
    vars: {
      ...
      '--color-primary-text': '252 148 163',
  ...
  },
  {
    ...
    vars: {
      ...
      '--color-primary-text': '113 175 251',
  ...
  },
  {
    ...
    vars: {
      ...
      '--color-primary-text': '182 159 251',
      '--color-primary-hover': '144 99 246',
      '--color-primary-light': '196 181 253',
  ...
  },
  {
    ...
    vars: {
      ...
      '--color-primary-text': '249 134 134',
  ...
  },
  {
    ...
    vars: {
      ...
      '--color-primary-text': '203 213 225',
...
.mc-nav-link:hover { color: rgb(var(--color-primary-text, var(--color-primary-light))) !important; }
.mc-nav-link.active { color: rgb(var(--color-primary-text, var(--color-primary-light))) !important; }
